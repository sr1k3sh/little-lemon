    ...
    <section className='bg-primary py-8'>
      <div className='container m-auto'>
        <div className='flex flex-col md:flex-row justify-center mb-4 gap-8'>
          <nav className='flex flex-col text-center sm:flex-row gap-4 lg:gap-8 text-primary-foreground justify-center'>
            <Link href='/'>Home</Link>
        ...
        <div className='w-24 h-24 relative m-auto'>
          <Image src="/logo.svg" alt="little lemon" fill></Image>
        </div>
